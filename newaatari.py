...
class ReplayMemory:
    ...
    def add_experience(self, action, reward, done, next_frame):
        ...
        self.frames[self.count] = next_frame # TODO: CHECK ... here
...
class Atari:
    ...
    def reset(self, sess, evaluation=False):
        ...
        frame_deque.append(processed_frame)
        frame_deque.append(processed_frame)
        self.state = np.stack(frame_deque, axis=2)
    ...
    def step(self, sess, action):
        ...
        processed_new_framee = preprocess_frame(new_frame)  # (6★)
        frame_deque.append(processed_new_framee)
        new_state = np.stack(frame_deque, axis=2)
        self.state = new_state

        return processed_new_framee, reward, terminal, terminal_life_lost, new_frame
